...
export default function Reviews() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      const enriched: ReviewWithAppName[] = reviews
        .map((r) => ({ ...r, appName: appMap.get(r.appId)?.name ?? 'Unknown App' }))
  ...
  const filteredReviews = filterType
    ? allReviews.filter((r) => r.learnerType === filterType)
    : allReviews;
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-['Inter:Regular',sans-serif] font-normal text-[14px] text-[#94a3b8]">
