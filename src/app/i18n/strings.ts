...
export const DICT = {
  ...
  'suggest.errReason':       { ko: '추천하는 이유를 하나 이상 골라주세요.', en: 'Please choose at least one reason.' },
  'suggest.errCustom':       { ko: '추천 이유를 적어주세요.', en: 'Please tell us why you recommend it.' },
  'suggest.needRequired':    { ko: '별표(*) 항목을 채워야 보낼 수 있어요.', en: 'Fill in the starred (*) fields to submit.' },
