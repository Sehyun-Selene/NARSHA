...
(
  ...
  array['aiFeedback'],
  array['format.native_speaker_clips','strength.real_life_phrases','mechanism.bite_sized_lessons','ux.gamification','fit.casual_learner','ux.offline_paid_only'],
...
(
  ...
  array['noFeedback'],
  array['strength.grammar_explanation','mechanism.numbered_curriculum','authority.expert_designed','fit.needs_structure','ux.multilingual_interface','ux.offline_paid_only'],
...
(
  ...
  array['noFeedback'],
  array['ux.gamification','mechanism.bite_sized_lessons','pace.daily_short_session','fit.casual_learner','ux.multilingual_interface','ux.offline_paid_only'],
...
(
  ...
  array['lang.english','lang.multilingual_20plus'],
  array['noFeedback'],
  array['mechanism.bite_sized_lessons','pace.daily_short_session','format.flashcard','fit.casual_learner','ux.offline_paid_only'],
  array[]::text[],
  array['Android','Website','iOS'],
...
(
  ...
  array['lang.english'],
  array['noFeedback'],
  array['authority.expert_designed','instructor.institutional','format.video_lecture','pace.deep_dive_session','social.companion_service_paid','ux.offline_paid_only'],
  array['limit.requires_supplementary'],
  array['Android','Website','iOS'],
...
(
  ...
  array['humanFeedback'],
  array['mechanism.numbered_curriculum','social.peer_interaction','strength.grammar_explanation','fit.needs_structure','ux.multilingual_interface','ux.offline_paid_only'],
  array['limit.weak_in_advanced'],
  array['Android','Website','iOS'],
  'https://www.busuu.com',
...
(
  ...
  array['lang.user_defined'],
  array['aiFeedback'],
  array['format.flashcard','mechanism.active_recall','mechanism.topic_based','social.community_forum','strength.vocabulary_volume','ux.offline_paid_only'],
  array[]::text[],
  array['Android','Website','iOS'],
  'https://quizlet.com',
...
(
  ...
  array['lang.english'],
  array['noFeedback'],
  array['instructor.institutional','fit.career_focused','ux.offline_paid_only'],
  array[]::text[],
  array['Android','Website','iOS'],
